...
from gui.testing.models import Testresult
...
class MetricsManager:
    ...
    def similarity_cosine_single_source(self, solutions: list[Solution]):
        return self.__similarity_metric__.calculate_cosine_similarity_single_source(solutions)

    def similarity_cosine_multiple_source(self, solutions: list[Solution]):
    ...
    def success_rate_single_solution(self, results: list[Testresult]):
        pass
